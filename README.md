...
│   │   └── original.pdf
│   └── output/                     ← 生成されたスライド
│       ├── YYYY-MM-DD_トピック名.pptx
│       └── YYYY-MM-DD_トピック名.pdf
│
...
| ファイル | 同期 | 理由 |
|---------|------|------|
| `output/YYYY-MM-DD_トピック名.pdf` | ✅ する | 閲覧・共有用の最終成果物 |
| `output/YYYY-MM-DD_トピック名.pptx` | ✅ する | 編集可能な元ファイル |
...
3. **ファイル抽出**:
   - `YYYY-MM-DD_トピック名/output/YYYY-MM-DD_トピック名.pdf` を対象
   - `YYYY-MM-DD_トピック名/output/YYYY-MM-DD_トピック名.pptx` を対象
...
│   ├── 2026-04-08_snowflake-クラスタリングと検索最適化.pdf
│   └── 2026-04-08_snowflake-クラスタリングと検索最適化.pptx
│
├── 2026-04-15_react-hooks-実践/
│   ├── 2026-04-15_react-hooks-実践.pdf
│   └── 2026-04-15_react-hooks-実践.pptx
│
└── 2026-04-20_aws-lambda-入門/
    ├── 2026-04-20_aws-lambda-入門.pdf
    └── 2026-04-20_aws-lambda-入門.pptx
```
